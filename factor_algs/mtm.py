...
class CCfgFactorGrpMTM(CCfgFactorGrpWin):
    def __init__(self, **kwargs):
        super().__init__(factor_class="MTM", **kwargs)
...
class CFactorMTM(CFactorsByInstru):
    def __init__(self, factor_grp: CCfgFactorGrpMTM, **kwargs):
        if not isinstance(factor_grp, CCfgFactorGrpMTM):
            raise TypeError("factor_grp must be CCfgFactorGrpMTM")
